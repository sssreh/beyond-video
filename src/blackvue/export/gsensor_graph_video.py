...
def render_gsensor_graph_video(
    ...
    *,
    ...
    reasoning (the vertical axis "is just not useful, unless you hit a
    giant pothole, but then the video probably got that and the
    reaction of the driver"; see that docstring's "hidden by default"
    paragraph for the full letter-churn history of which letter has
    named this opt-in axis). Pass True for a specific look at a
