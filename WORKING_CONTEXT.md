...
Flagging the other `bv-*` CLIs' own exposure to this same bug class to Christer directly, and asking whether he wants the same `allow_abbrev=False` applied there too now or left for if/when it actually bites.
