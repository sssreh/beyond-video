...
If you own a BlackVue camera model that isn't a DR900S-2CH, running a quick scan against your own camera and reporting back what you find is one of the most useful things you could do for this project - no firmware access, reverse engineering, or coding required.
